...
(слайд 23) SAPI - это интерфейс получения данных из внешнего мира в теле скрипта (нужно для программиста) и система управления стадиями работы ядра (Zend Engine). SAPI запускается в самом начале работы интерпретатора. Оно формирует список суперглобальных массивов (интерфейс получения внешних данных для прогрограммиста) из пришедших из внешнего мира данных и производит ряд действий по управлению ядром. В общих чертах это: запуск ядра, ряд внутрених технических действий и остановку ядра в конце работы. 
