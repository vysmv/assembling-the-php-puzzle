...
Если в директории `/var/www/html/` я создам новый файл (script.php).
...
Протокол CGI был придуман, чтобы веб-сервер мог запускать программы написанные на разных языках программирования. 
...
Давайте тут сделаем ответвление и разберем, то как запускаются программы в терминале, а потом снова вернемся к Apache2 и CGI.
