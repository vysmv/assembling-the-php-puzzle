...
### Подготовка демонтстрационного стенда [Пропуск]
...
### Запуск программ в терминале [Пропуск]
...
### Общий принцип работы с вводом и выводом в Unix-подобных системах [Пропуск]
